        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.bt_sms2:
                    ...
                    if(TextUtils.isEmpty(editTextYanzheng.getText())){
                        Toast.makeText(SMSActivity.this, "验证码不能为空！", Toast.LENGTH_SHORT).show();
                    }else {
                        dengluHttp();
                    }
                    break;
    ...
    private void dengluHttp() {
        ...
        utils.getJson(url, new HttpUtils.HttpCallBack() {
            ...
            public void onSusscess(String data) {
                ...
                SharedPreferencesUtils.setParam(SMSActivity.this, "SMSData", smsData.getData().toString());
                aCache.put("MobilNumber",editTextMobilNumber.getText().toString(),1000000000);
                aCache.put("yanzhengma",editTextYanzheng.getText().toString());
                SharedPreferencesUtils.setParam(SMSActivity.this, "MobilNumber", editTextMobilNumber.getText().toString());
                SharedPreferencesUtils.setParam(SMSActivity.this,"yanzhengma",editTextYanzheng.getText().toString());
                if (smsData.isIsOK()==true){
                    SharedPreferencesUtils.setParam(SMSActivity.this, "lasttime", getCurTimeString());
                    smsObserver.unregisterSMSObserver();
                    MyUtils.inTent(SMSActivity.this,MainActivity.class);
                    finish();
                }else {
