 ...
 */
public class MyHotShopSalesAdapter extends AnimRecyclerViewAdapter<MyHotShopSalesAdapter.ViewHolder> {
    HotShopSales hotShop;

    public MyHotShopSalesAdapter(HotShopSales hotShop) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(
                R.layout.list_hotshopsales_item, parent, false);
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        holder.textView2.setText(hotShop.getData().get(position).getOuterIid() + "");
        holder.textView1.setText(hotShop.getData().get(position).getOuterSkuId()+"");
        holder.textView3.setText(hotShop.getData().get(position).getNum()+"");
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            textView3 = (TextView) itemView.findViewById(R.id.tv4_listview_hot);
        }
    }
}
